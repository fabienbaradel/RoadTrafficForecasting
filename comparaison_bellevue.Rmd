...
#IMPORT DATA FROM PA
#NAIVE
NAIVE_SpeedValue_TimeStepXSection_H_1 <- read.csv("~/R/Error/Bellevue/NAIVE/NAIVE_SpeedValue_TimeStepXSection_H_1.csv", header=FALSE)
NAIVE_SpeedValue_TimeStepXSection_H_2 <- read.csv("~/R/Error/Bellevue/NAIVE/NAIVE_SpeedValue_TimeStepXSection_H_2.csv", header=FALSE)
NAIVE_SpeedValue_TimeStepXSection_H_3 <- read.csv("~/R/Error/Bellevue/NAIVE/NAIVE_SpeedValue_TimeStepXSection_H_3.csv", header=FALSE)
NAIVE_SpeedValue_TimeStepXSection_H_4 <- read.csv("~/R/Error/Bellevue/NAIVE/NAIVE_SpeedValue_TimeStepXSection_H_4.csv", header=FALSE)
NAIVE_SpeedValue_TimeStepXSection_H_5 <- read.csv("~/R/Error/Bellevue/NAIVE/NAIVE_SpeedValue_TimeStepXSection_H_5.csv", header=FALSE)
NAIVE_SpeedValue_TimeStepXSection_H_6 <- read.csv("~/R/Error/Bellevue/NAIVE/NAIVE_SpeedValue_TimeStepXSection_H_6.csv", header=FALSE)

NAIVE_Y_pred_Bellevue <- array(NA, dim=c(dim(Bellevue_Matrix)[2], nbHorizons, F[2]-F[1]+1),  dimnames = list(
                                                                              dimnames(Bellevue_Matrix)[[2]],
                                                                              paste("prévision à",H),
                                                                              (F[1]:(F[2])
                                                                              )))
NAIVE_Y_pred_Bellevue[,1,] <- t(NAIVE_SpeedValue_TimeStepXSection_H_1)
NAIVE_Y_pred_Bellevue[,2,-1] <- t(NAIVE_SpeedValue_TimeStepXSection_H_2)
NAIVE_Y_pred_Bellevue[,3,-(1:2)] <- t(NAIVE_SpeedValue_TimeStepXSection_H_3)
NAIVE_Y_pred_Bellevue[,4,-(1:3)] <- t(NAIVE_SpeedValue_TimeStepXSection_H_4)
NAIVE_Y_pred_Bellevue[,5,-(1:4)] <- t(NAIVE_SpeedValue_TimeStepXSection_H_5)
NAIVE_Y_pred_Bellevue[,6,-(1:5)] <- t(NAIVE_SpeedValue_TimeStepXSection_H_6)

#SECTIONS <- (1:600)[-147]


result_Bellevue_NAIVE_Bellevue <- result_APE_MAPE(NAIVE_Y_pred_Bellevue[,,], Bellevue_Matrix[,], 2929)
result_Bellevue_NAIVE_Bellevue$MAPE_local

#kNN Dev
kNN_DEV_SpeedValue_TimeStepXSection_H_1 <- read.csv("~/R/Error/Bellevue/kNN_DEV/kNN_DEV_SpeedValue_TimeStepXSection_H_1.csv", header=FALSE)
kNN_DEV_SpeedValue_TimeStepXSection_H_2 <- read.csv("~/R/Error/Bellevue/kNN_DEV/kNN_DEV_SpeedValue_TimeStepXSection_H_2.csv", header=FALSE)
kNN_DEV_SpeedValue_TimeStepXSection_H_3 <- read.csv("~/R/Error/Bellevue/kNN_DEV/kNN_DEV_SpeedValue_TimeStepXSection_H_3.csv", header=FALSE)
kNN_DEV_SpeedValue_TimeStepXSection_H_4 <- read.csv("~/R/Error/Bellevue/kNN_DEV/kNN_DEV_SpeedValue_TimeStepXSection_H_4.csv", header=FALSE)
kNN_DEV_SpeedValue_TimeStepXSection_H_5 <- read.csv("~/R/Error/Bellevue/kNN_DEV/kNN_DEV_SpeedValue_TimeStepXSection_H_5.csv", header=FALSE)
kNN_DEV_SpeedValue_TimeStepXSection_H_6 <- read.csv("~/R/Error/Bellevue/kNN_DEV/kNN_DEV_SpeedValue_TimeStepXSection_H_6.csv", header=FALSE)

kNN_DEV_Y_pred_Bellevue <- array(NA, dim=c(dim(Bellevue_Matrix)[2], nbHorizons, F[2]-F[1]+1),  dimnames = list(
                                                                              dimnames(Bellevue_Matrix)[[2]],
                                                                              paste("prévision à",H),
                                                                              (F[1]:(F[2])
                                                                              )))
kNN_DEV_Y_pred_Bellevue[,1,] <- t(kNN_DEV_SpeedValue_TimeStepXSection_H_1)
kNN_DEV_Y_pred_Bellevue[,2,-1] <- t(kNN_DEV_SpeedValue_TimeStepXSection_H_2)
kNN_DEV_Y_pred_Bellevue[,3,-(1:2)] <- t(kNN_DEV_SpeedValue_TimeStepXSection_H_3)
kNN_DEV_Y_pred_Bellevue[,4,-(1:3)] <- t(kNN_DEV_SpeedValue_TimeStepXSection_H_4)
kNN_DEV_Y_pred_Bellevue[,5,-(1:4)] <- t(kNN_DEV_SpeedValue_TimeStepXSection_H_5)
kNN_DEV_Y_pred_Bellevue[,6,-(1:5)] <- t(kNN_DEV_SpeedValue_TimeStepXSection_H_6)


result_Bellevue_kNN_DEV_Bellevue <- result_APE_MAPE(kNN_DEV_Y_pred_Bellevue[,,], Bellevue_Matrix[,], 2929)
result_Bellevue_kNN_DEV_Bellevue$MAPE_mean

#kNN DIRECT
kNN_DIRECT_SpeedValue_TimeStepXSection_H_1 <- read.csv("~/R/Error/Bellevue/kNN_DIRECT/kNN_DIRECT_SpeedValue_TimeStepXSection_H_1.csv", header=FALSE)
kNN_DIRECT_SpeedValue_TimeStepXSection_H_2 <- read.csv("~/R/Error/Bellevue/kNN_DIRECT/kNN_DIRECT_SpeedValue_TimeStepXSection_H_2.csv", header=FALSE)
kNN_DIRECT_SpeedValue_TimeStepXSection_H_3 <- read.csv("~/R/Error/Bellevue/kNN_DIRECT/kNN_DIRECT_SpeedValue_TimeStepXSection_H_3.csv", header=FALSE)
kNN_DIRECT_SpeedValue_TimeStepXSection_H_4 <- read.csv("~/R/Error/Bellevue/kNN_DIRECT/kNN_DIRECT_SpeedValue_TimeStepXSection_H_4.csv", header=FALSE)
kNN_DIRECT_SpeedValue_TimeStepXSection_H_5 <- read.csv("~/R/Error/Bellevue/kNN_DIRECT/kNN_DIRECT_SpeedValue_TimeStepXSection_H_5.csv", header=FALSE)
kNN_DIRECT_SpeedValue_TimeStepXSection_H_6 <- read.csv("~/R/Error/Bellevue/kNN_DIRECT/kNN_DIRECT_SpeedValue_TimeStepXSection_H_6.csv", header=FALSE)

kNN_DIRECT_Y_pred_Bellevue <- array(NA, dim=c(dim(Bellevue_Matrix)[2], nbHorizons, F[2]-F[1]+1),  dimnames = list(
                                                                              dimnames(Bellevue_Matrix)[[2]],
                                                                              paste("prévision à",H),
                                                                              (F[1]:(F[2])
                                                                              )))
kNN_DIRECT_Y_pred_Bellevue[,1,] <- t(kNN_DIRECT_SpeedValue_TimeStepXSection_H_1)
kNN_DIRECT_Y_pred_Bellevue[,2,-1] <- t(kNN_DIRECT_SpeedValue_TimeStepXSection_H_2)
kNN_DIRECT_Y_pred_Bellevue[,3,-(1:2)] <- t(kNN_DIRECT_SpeedValue_TimeStepXSection_H_3)
kNN_DIRECT_Y_pred_Bellevue[,4,-(1:3)] <- t(kNN_DIRECT_SpeedValue_TimeStepXSection_H_4)
kNN_DIRECT_Y_pred_Bellevue[,5,-(1:4)] <- t(kNN_DIRECT_SpeedValue_TimeStepXSection_H_5)
kNN_DIRECT_Y_pred_Bellevue[,6,-(1:5)] <- t(kNN_DIRECT_SpeedValue_TimeStepXSection_H_6)


result_Bellevue_kNN_DIRECT_Bellevue <- result_APE_MAPE(kNN_DIRECT_Y_pred_Bellevue[,,], Bellevue_Matrix[,], 2929)
result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local
...
```{r}
#MAPE MEAN
MAPE_mean_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
MAPE_mean_Bellevue[1,] <- online_Bellevue_hist_30$MAPE_mean
MAPE_mean_Bellevue[2,] <- result_Bellevue_NAIVE_Bellevue$MAPE_mean
MAPE_mean_Bellevue[3,] <- result_Bellevue_kNN_DEV_Bellevue$MAPE_mean
MAPE_mean_Bellevue[4,] <- result_Bellevue_kNN_DIRECT_Bellevue$MAPE_mean

MAPE_mean_Bellevue_df <- adply(MAPE_mean_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=MAPE_mean_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#RMSE MEAN
RMSE_mean_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
RMSE_mean_Bellevue[1,] <- online_Bellevue_hist_30$RMSE_mean
RMSE_mean_Bellevue[2,] <- result_Bellevue_NAIVE_Bellevue$RMSE_mean
RMSE_mean_Bellevue[3,] <- result_Bellevue_kNN_DEV_Bellevue$RMSE_mean
RMSE_mean_Bellevue[4,] <- result_Bellevue_kNN_DIRECT_Bellevue$RMSE_mean

RMSE_mean_Bellevue_df <- adply(RMSE_mean_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=RMSE_mean_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#MAPE MEDIAN
MAPE_median_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
MAPE_median_Bellevue[1,] <- rowMedians(online_Bellevue_hist_30$MAPE_global, na.rm = T)
MAPE_median_Bellevue[2,] <- rowMedians(result_Bellevue_NAIVE_Bellevue$MAPE_global, na.rm = T)
MAPE_median_Bellevue[3,] <- rowMedians(result_Bellevue_kNN_DEV_Bellevue$MAPE_global, na.rm = T)
MAPE_median_Bellevue[4,] <- rowMedians(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global, na.rm = T)

MAPE_median_Bellevue_df <- adply(MAPE_median_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=MAPE_median_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#RMSE MEDIAN
RMSE_median_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
RMSE_median_Bellevue[1,] <- rowMedians(online_Bellevue_hist_30$RMSE_global, na.rm = T)
RMSE_median_Bellevue[2,] <- rowMedians(result_Bellevue_NAIVE_Bellevue$RMSE_global, na.rm = T)
RMSE_median_Bellevue[3,] <- rowMedians(result_Bellevue_kNN_DEV_Bellevue$RMSE_global, na.rm = T)
RMSE_median_Bellevue[4,] <- rowMedians(result_Bellevue_kNN_DIRECT_Bellevue$RMSE_global, na.rm = T)

RMSE_median_Bellevue_df <- adply(RMSE_median_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=RMSE_median_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#MAPE SD
MAPE_sd_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
MAPE_sd_Bellevue[1,] <- rowSds(online_Bellevue_hist_30$MAPE_global, na.rm = T)
MAPE_sd_Bellevue[2,] <- rowSds(result_Bellevue_NAIVE_Bellevue$MAPE_global, na.rm = T)
MAPE_sd_Bellevue[3,] <- rowSds(result_Bellevue_kNN_DEV_Bellevue$MAPE_global, na.rm = T)
MAPE_sd_Bellevue[4,] <- rowSds(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global, na.rm = T)

MAPE_sd_Bellevue_df <- adply(MAPE_sd_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=MAPE_sd_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#RMSE SD
RMSE_sd_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
RMSE_sd_Bellevue[1,] <- rowSds(online_Bellevue_hist_30$RMSE_global, na.rm = T)
RMSE_sd_Bellevue[2,] <- rowSds(result_Bellevue_NAIVE_Bellevue$RMSE_global, na.rm = T)
RMSE_sd_Bellevue[3,] <- rowSds(result_Bellevue_kNN_DEV_Bellevue$RMSE_global, na.rm = T)
RMSE_sd_Bellevue[4,] <- rowSds(result_Bellevue_kNN_DIRECT_Bellevue$RMSE_global, na.rm = T)

RMSE_sd_Bellevue_df <- adply(RMSE_sd_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=RMSE_sd_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#MAPE CV
MAPE_cv_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
MAPE_cv_Bellevue <- MAPE_sd_Bellevue / MAPE_mean_Bellevue 


MAPE_cv_Bellevue_df <- adply(MAPE_cv_Bellevue, c(1,2))

col <- c("black", "red", "green", "blue")
p1 <- ggplot(data=MAPE_cv_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
#RMSE CV
RMSE_cv_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
RMSE_cv_Bellevue <- RMSE_sd_Bellevue / RMSE_mean_Bellevue 


RMSE_cv_Bellevue_df <- adply(RMSE_cv_Bellevue, c(1,2))

p1 <- ggplot(data=RMSE_cv_Bellevue_df, aes(x=X2, y=V1, colour=X1, shape=X1, group = X1))
...
```{r}
##MAPE
MAPE_Bellevue <- array(0, dim=c(4, 6, 1439), dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        2930:4368) )

MAPE_Bellevue[1,,] <- online_Bellevue_hist_30$MAPE_global
MAPE_Bellevue[2,,] <- result_Bellevue_NAIVE_Bellevue$MAPE_global
MAPE_Bellevue[3,,] <- result_Bellevue_kNN_DEV_Bellevue$MAPE_global
MAPE_Bellevue[4,,] <- result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global

MAPE_Bellevue_df <- adply(MAPE_Bellevue, c(1,2,3)) #0h30
str(MAPE_Bellevue_df)

#density
rows <- which(MAPE_Bellevue_df$X2=="0h30")
p1 <- ggplot(data=MAPE_Bellevue_df[rows,], aes(x=V1) )
...
rows <- which(MAPE_Bellevue_df$X2=="1h30")
p3 <- ggplot(data=MAPE_Bellevue_df[rows,], aes(x=V1) )
...
rows <- which(MAPE_Bellevue_df$X2=="2h00")
p4 <- ggplot(data=MAPE_Bellevue_df[rows,], aes(x=V1) )
...
rows <- which(MAPE_Bellevue_df$X2=="3h00")
p6 <- ggplot(data=MAPE_Bellevue_df[rows,], aes(x=V1) )
...
##RMSE
RMSE_Bellevue <- array(0, dim=c(4, 6, 1439), dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        2930:4368) )

RMSE_Bellevue[1,,] <- online_Bellevue_hist_30$RMSE_global
RMSE_Bellevue[2,,] <- result_Bellevue_NAIVE_Bellevue$RMSE_global
RMSE_Bellevue[3,,] <- result_Bellevue_kNN_DEV_Bellevue$RMSE_global
RMSE_Bellevue[4,,] <- result_Bellevue_kNN_DIRECT_Bellevue$RMSE_global

RMSE_Bellevue_df <- adply(RMSE_Bellevue, c(1,2,3)) #0h30
str(RMSE_Bellevue_df)

#density
rows <- which(RMSE_Bellevue_df$X2=="0h30")
p1 <- ggplot(data=RMSE_Bellevue_df[rows,], aes(x=V1) )
...
rows <- which(RMSE_Bellevue_df$X2=="1h30")
p3 <- ggplot(data=RMSE_Bellevue_df[rows,], aes(x=V1) )
...
rows <- which(RMSE_Bellevue_df$X2=="2h00")
p4 <- ggplot(data=RMSE_Bellevue_df[rows,], aes(x=V1) )
...
rows <- which(RMSE_Bellevue_df$X2=="3h00")
p6 <- ggplot(data=RMSE_Bellevue_df[rows,], aes(x=V1) )
...
```{r}
#mean
MAPE_plus_minus_Bellevue <- array(0, c(4, 6, 2), dimnames = list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        c("MAPE+", "MAPE-")))
...
for(h in 1:6){
  #online_SVR
  #MPE+
  rows <- which(online_Bellevue_hist_30$relative_ERROR[,h,] > 0)
  MAPE_plus_minus_Bellevue[1,h,1] <- mean(online_Bellevue_hist_30$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MAPE_plus_minus_Bellevue[1,h,2] <- -mean(online_Bellevue_hist_30$relative_ERROR[,h,][-rows], na.rm = T)
  
  #NAIVE
  #MPE+
  rows <- which(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,] > 0)
  MAPE_plus_minus_Bellevue[2,h,1] <- mean(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MAPE_plus_minus_Bellevue[2,h,2] <- -mean(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)
  
  #kNN_DIRECT
  #MPE+
  rows <- which(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,] > 0)
  MAPE_plus_minus_Bellevue[4,h,1] <- mean(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MAPE_plus_minus_Bellevue[4,h,2] <- -mean(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)
  
  #kNN_DEV
  #MPE+
  rows <- which(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,] > 0)
  MAPE_plus_minus_Bellevue[3,h,1] <- mean(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MAPE_plus_minus_Bellevue[3,h,2] <- -mean(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)

  }

MAPE_plus_minus_Bellevue_df <- adply(MAPE_plus_minus_Bellevue, c(2,1))
str(MAPE_plus_minus_Bellevue_df)
colnames(MAPE_plus_minus_Bellevue_df) <- c("X1", "X2", "V1", "V2")

p1 <- ggplot(data=MAPE_plus_minus_Bellevue_df, aes(x=V1, y=V2, group=X2, shape= X2, colour=X2) )
...
#median
MEDIAN_plus_minus_Bellevue <- array(0, c(4, 6, 2), dimnames = list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        c("MEDIAN+", "MEDIAN-")))
...
for(h in 1:6){
  ...
  #MPE+
  rows <- which(online_Bellevue_hist_30$relative_ERROR[,h,] > 0)
  MEDIAN_plus_minus_Bellevue[1,h,1] <- median(online_Bellevue_hist_30$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MEDIAN_plus_minus_Bellevue[1,h,2] <- -median(online_Bellevue_hist_30$relative_ERROR[,h,][-rows], na.rm = T)
  
  #NAIVE
  #MPE+
  rows <- which(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,] > 0)
  MEDIAN_plus_minus_Bellevue[2,h,1] <- median(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MEDIAN_plus_minus_Bellevue[2,h,2] <- -median(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)
  
  #kNN_DIRECT
  #MPE+
  rows <- which(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,] > 0)
  MEDIAN_plus_minus_Bellevue[4,h,1] <- median(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MEDIAN_plus_minus_Bellevue[4,h,2] <- -median(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)
  
  #kNN_DEV
  #MPE+
  rows <- which(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,] > 0)
  MEDIAN_plus_minus_Bellevue[3,h,1] <- median(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  MEDIAN_plus_minus_Bellevue[3,h,2] <- -median(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)

  }

MEDIAN_plus_minus_Bellevue_df <- adply(MEDIAN_plus_minus_Bellevue, c(2,1))
str(MEDIAN_plus_minus_Bellevue_df)
colnames(MEDIAN_plus_minus_Bellevue_df) <- c("X1", "X2", "V1", "V2")

p1 <- ggplot(data=MEDIAN_plus_minus_Bellevue_df, aes(x=V1, y=V2, group=X2, shape= X2, colour=X2) )
...
#sd
sd_plus_minus_Bellevue <- array(0, c(4, 6, 2), dimnames = list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        c("sd+", "sd-")))
...
for(h in 1:6){
  ...
  #MPE+
  rows <- which(online_Bellevue_hist_30$relative_ERROR[,h,] > 0)
  sd_plus_minus_Bellevue[1,h,1] <- sd(online_Bellevue_hist_30$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  sd_plus_minus_Bellevue[1,h,2] <- sd(online_Bellevue_hist_30$relative_ERROR[,h,][-rows], na.rm = T)
  
  #NAIVE
  #MPE+
  rows <- which(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,] > 0)
  sd_plus_minus_Bellevue[2,h,1] <- sd(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  sd_plus_minus_Bellevue[2,h,2] <- sd(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)
  
  #kNN_DIRECT
  #MPE+
  rows <- which(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,] > 0)
  sd_plus_minus_Bellevue[4,h,1] <- sd(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  sd_plus_minus_Bellevue[4,h,2] <- sd(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)
  
  #kNN_DEV
  #MPE+
  rows <- which(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,] > 0)
  sd_plus_minus_Bellevue[3,h,1] <- sd(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,][rows], na.rm = T)
  #MPE-
  sd_plus_minus_Bellevue[3,h,2] <- sd(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,][-rows], na.rm = T)

  }

sd_plus_minus_Bellevue_df <- adply(sd_plus_minus_Bellevue, c(2,1))
str(sd_plus_minus_Bellevue_df)
colnames(sd_plus_minus_Bellevue_df) <- c("X1", "X2", "V1", "V2")

p1 <- ggplot(data=sd_plus_minus_Bellevue_df, aes(x=V1, y=V2, group=X2, shape= X2, colour=X2) )
...
# 3000-2930+1
# plot(Bellevue_Matrix[2930:4000, 1], type='l')
# lines(result_Bellevue_kNN_DIRECT_Bellevue$Y_pred[1,1,1:(4000-2930+1)], col='red')
```
...
for(h in 1:4){
  #online_SVR
  relative_error_Bellevue[1,h,,] <- online_Bellevue_hist_30$relative_ERROR[,hours[h], ]
  
  #NAIVE
  relative_error_Bellevue[2,h,] <- result_Bellevue_NAIVE_Bellevue$relative_ERROR[,hours[h], ]
  
  #kNN_DIRECT
  #MPE+
  relative_error_Bellevue[3,h,] <- result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,hours[h], ]
  
  #kNN_DEV
  relative_error_Bellevue[4,h,] <- result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,hours[h], ]
}
...
h <- 1
n <- 10000
plot(density(c(online_Bellevue_hist_30$relative_ERROR[,h,]),na.rm =T, n=n), xlim=c(-10,8), ylim=c(0.015, 0.15), ylab="Densité", col='red', main = "Densités empiriques selon la méthode de prévision à 0h30", xlab="Erreur relative  (en %)")
lines(density(c(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,]),na.rm =T, n=n) , col='chartreuse3') 
lines(density(c(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,]),na.rm =T,  n=n) , col='darkorchid')
lines(density(c(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,]), na.rm =T, n=n) , col='aquamarine2')
legend(-9, .12, c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),  lty=c(1,1), lwd=c(2,2), col=c('red', 'chartreuse3','aquamarine2', 'darkorchid'))

#1h30 min
h <- 2
n <- 10000
plot(density(c(online_Bellevue_hist_30$relative_ERROR[,h,]),na.rm =T, n=n), xlim=c(-8,9), ylim=c(0.015, 0.11), ylab="Densité", col='red', main = "Densités empiriques selon la méthode de prévision à 1h30", xlab="Erreur relative (en %)")
lines(density(c(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,]),na.rm =T, n=n) , col='chartreuse3') 
lines(density(c(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,]),na.rm =T,  n=n) , col='darkorchid')
lines(density(c(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,]), na.rm =T, n=n) , col='aquamarine2')
...
h <- 4
n <- 10000
plot(density(c(online_Bellevue_hist_30$relative_ERROR[,h,]),na.rm =T, n=n), xlim=c(-8,14), ylim=c(0.01, 0.067), ylab="Densité", col='red', main = "Densités empiriques selon la méthode de prévision à 2h", xlab="Erreur relative (en %)")
lines(density(c(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,]),na.rm =T, n=n) , col='chartreuse3') 
lines(density(c(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,]),na.rm =T,  n=n) , col='darkorchid')
lines(density(c(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,]), na.rm =T, n=n) , col='aquamarine2')
...
h <- 6
n <- 10000
plot(density(c(online_Bellevue_hist_30$relative_ERROR[,h,]),na.rm =T, n=n), xlim=c(-9,20), ylim=c(0.01, 0.05), ylab="Densité", col='red', main = "Densités empiriques selon la méthode de prévision à 3h", xlab="Erreur relative (en %)")
lines(density(c(result_Bellevue_NAIVE_Bellevue$relative_ERROR[,h,]),na.rm =T, n=n) , col='chartreuse3') 
lines(density(c(result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR[,h,]),na.rm =T,  n=n) , col='darkorchid')
lines(density(c(result_Bellevue_kNN_DEV_Bellevue$relative_ERROR[,h,]), na.rm =T, n=n) , col='aquamarine2')
...
#COUNT HOW MANY LOWEST GLOBAL EACH METHOD GETS
  ...
  for(h in 1:nbHorizons){
    for(i in h:1439){
      if(online_Bellevue_hist_30$MAPE_global[h,i] < result_Bellevue_NAIVE_Bellevue$MAPE_global[h,i]
         & online_Bellevue_hist_30$MAPE_global[h,i] < result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[h,i]
         & online_Bellevue_hist_30$MAPE_global[h,i] < result_Bellevue_kNN_DEV_Bellevue$MAPE_global[h,i]){
        lowest_global_MAPE[h,1,i]  <- 1
      } else if(result_Bellevue_NAIVE_Bellevue$MAPE_global[h,i] < result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[h,i]
         & result_Bellevue_NAIVE_Bellevue$MAPE_global[h,i] < online_Bellevue_hist_30$MAPE_global[h,i]
         & result_Bellevue_NAIVE_Bellevue$MAPE_global[h,i] < result_Bellevue_kNN_DEV_Bellevue$MAPE_global[h,i]){
        lowest_global_MAPE[h,2,i]  <- 1
      } else if(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[h,i] < online_Bellevue_hist_30$MAPE_global[h,i]
         & result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[h,i] < result_Bellevue_kNN_DEV_Bellevue$MAPE_global[h,i]
         & result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[h,i] < result_Bellevue_NAIVE_Bellevue$MAPE_global[h,i]){
        lowest_global_MAPE[h,3,i]  <- 1
      } else if(result_Bellevue_kNN_DEV_Bellevue$MAPE_global[h,i] < online_Bellevue_hist_30$MAPE_global[h,i]
         &result_Bellevue_kNN_DEV_Bellevue$MAPE_global[h,i] < result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[h,i]
         & result_Bellevue_kNN_DEV_Bellevue$MAPE_global[h,i] < result_Bellevue_NAIVE_Bellevue$MAPE_global[h,i]){
...
MAPE_median_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
MAPE_median_Bellevue[1,] <- colMedians(online_Bellevue_hist_30$MAPE_local, na.rm = T)
MAPE_median_Bellevue[2,] <- colMedians(result_Bellevue_NAIVE_Bellevue$MAPE_local, na.rm = T)
MAPE_median_Bellevue[3,] <- colMedians(result_Bellevue_kNN_DEV_Bellevue$MAPE_local, na.rm = T)
MAPE_median_Bellevue[4,] <- colMedians(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local, na.rm = T)
...
RMSE_median_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
RMSE_median_Bellevue[1,] <- colMedians(online_Bellevue_hist_30$RMSE_local, na.rm = T)
RMSE_median_Bellevue[2,] <- colMedians(result_Bellevue_NAIVE_Bellevue$RMSE_local, na.rm = T)
RMSE_median_Bellevue[3,] <- colMedians(result_Bellevue_kNN_DEV_Bellevue$RMSE_local, na.rm = T)
RMSE_median_Bellevue[4,] <- colMedians(result_Bellevue_kNN_DIRECT_Bellevue$RMSE_local, na.rm = T)
...
MAPE_sd_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
MAPE_sd_Bellevue[1,] <- colSds(online_Bellevue_hist_30$MAPE_local, na.rm = T)
MAPE_sd_Bellevue[2,] <- colSds(result_Bellevue_NAIVE_Bellevue$MAPE_local, na.rm = T)
MAPE_sd_Bellevue[3,] <- colSds(result_Bellevue_kNN_DEV_Bellevue$MAPE_local, na.rm = T)
MAPE_sd_Bellevue[4,] <- colSds(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local, na.rm = T)
...
RMSE_sd_Bellevue <- matrix(0, 4, 6, dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                           H) )
RMSE_sd_Bellevue[1,] <- colSds(online_Bellevue_hist_30$RMSE_local, na.rm = T)
RMSE_sd_Bellevue[2,] <- colSds(result_Bellevue_NAIVE_Bellevue$RMSE_local, na.rm = T)
RMSE_sd_Bellevue[3,] <- colSds(result_Bellevue_kNN_DEV_Bellevue$RMSE_local, na.rm = T)
RMSE_sd_Bellevue[4,] <- colSds(result_Bellevue_kNN_DIRECT_Bellevue$RMSE_local, na.rm = T)
...
##MAPE
MAPE_Bellevue <- array(0, dim=c(4, 6, 599), dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        sec) )

MAPE_Bellevue[1,,] <- online_Bellevue_hist_30$MAPE_local
MAPE_Bellevue[2,,] <- result_Bellevue_NAIVE_Bellevue$MAPE_local
MAPE_Bellevue[3,,] <- result_Bellevue_kNN_DEV_Bellevue$MAPE_local
MAPE_Bellevue[4,,] <- result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local
...
##RMSE
RMSE_Bellevue <- array(0, dim=c(4, 6, 599), dimnames=list(c("online-SVR", "NAIVE", "kNN_DEV", "kNN_DIRECT"),
                                                        H,
                                                        sec) )

RMSE_Bellevue[1,,] <- online_Bellevue_hist_30$RMSE_local
RMSE_Bellevue[2,,] <- result_Bellevue_NAIVE_Bellevue$RMSE_local
RMSE_Bellevue[3,,] <- result_Bellevue_kNN_DEV_Bellevue$RMSE_local
RMSE_Bellevue[4,,] <- result_Bellevue_kNN_DIRECT_Bellevue$RMSE_local
...
#COUNT HOW MANY LOWEST GLOBAL EACH METHOD GETS
  ...
  for(h in 1:599){
    for(i in 1:6){
      if(online_Bellevue_hist_30$MAPE_local[h,i] < result_Bellevue_NAIVE_Bellevue$MAPE_local[h,i]
         & online_Bellevue_hist_30$MAPE_local[h,i] < result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local[h,i]
         & online_Bellevue_hist_30$MAPE_local[h,i] < result_Bellevue_kNN_DEV_Bellevue$MAPE_local[h,i]){
        lowest_local_MAPE[i,1,h]  <- 1
      } else if(result_Bellevue_NAIVE_Bellevue$MAPE_local[h,i] < result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local[h,i]
         & result_Bellevue_NAIVE_Bellevue$MAPE_local[h,i] < online_Bellevue_hist_30$MAPE_local[h,i]
         & result_Bellevue_NAIVE_Bellevue$MAPE_local[h,i] < result_Bellevue_kNN_DEV_Bellevue$MAPE_local[h,i]){
        lowest_local_MAPE[i,2,h]  <- 1
      } else if(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local[h,i] < online_Bellevue_hist_30$MAPE_local[h,i]
         & result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local[h,i] < result_Bellevue_kNN_DEV_Bellevue$MAPE_local[h,i]
         & result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local[h,i] < result_Bellevue_NAIVE_Bellevue$MAPE_local[h,i]){
        lowest_local_MAPE[i,3,h]  <- 1
      } else if(result_Bellevue_kNN_DEV_Bellevue$MAPE_local[h,i] < online_Bellevue_hist_30$MAPE_local[h,i]
         &result_Bellevue_kNN_DEV_Bellevue$MAPE_local[h,i] < result_Bellevue_kNN_DIRECT_Bellevue$MAPE_local[h,i]
         & result_Bellevue_kNN_DEV_Bellevue$MAPE_local[h,i] < result_Bellevue_NAIVE_Bellevue$MAPE_local[h,i]){
...
#   
  whichDate(3310)
  plot(Bellevue_Matrix[3073:3350,1], type='l')
  lines(result_Bellevue_kNN_DIRECT_Bellevue$Y_pred[1,6,(3073-2930+1):((3073-2930+1)+3350-3073)], col='violet')
   #lines(result_Bellevue_NAIVE_Bellevue$Y_pred[1,1,(3073-2930+1):((3073-2930+1)+3250-3073+1)], col='blue')
  lines(online_Bellevue_hist_30$Y_pred[1,3,(3073-2930+1):((3073-2930+1)+3350-3073)], col='red')
  dim(result_Bellevue_NAIVE_Bellevue$Y_pred)
  ...
  mat_ex <- matrix(NA, 3, length(3115:3310), dimnames= list(c("Vitesses réelles", "Prévisions kNN-DIRECT à 3 heures",
                                                            ...
                                                            3115:3310) )
  mat_ex[1,] <- Bellevue_Matrix[3115:3310,1]
  mat_ex[2,] <- result_Bellevue_kNN_DIRECT_Bellevue$Y_pred[1,6,(3115-2930+1):((3115-2930+1)+3310-3115)]
  mat_ex[3,] <- online_Bellevue_hist_30$Y_pred[1,3,(3115-2930+1):((3115-2930+1)+3310-3115)]
...
MAPE_per_day[1, , 1] <- rowMeans(online_Bellevue_hist_30$MAPE_global[,1:47], na.rm = T)
MAPE_per_day[2, , 1] <- rowMeans(result_Bellevue_NAIVE_Bellevue$MAPE_global[,1:47], na.rm = T) #naive
MAPE_per_day[4, , 1] <- rowMeans(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[,1:47], na.rm = T) #knn_direct
MAPE_per_day[3, , 1] <- rowMeans(result_Bellevue_kNN_DEV_Bellevue$MAPE_global[,1:47], na.rm = T) #knn_dev
for(i in 1:29){
  MAPE_per_day[1, , i+1] <- rowMeans(online_Bellevue_hist_30$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #svr
  MAPE_per_day[2, , i+1] <- rowMeans(result_Bellevue_NAIVE_Bellevue$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #naive
  MAPE_per_day[4, , i+1] <- rowMeans(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #knn_direct
  MAPE_per_day[3, , i+1] <- rowMeans(result_Bellevue_kNN_DEV_Bellevue$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #knn_dev
}
...
MAPE_per_week[1, , 5] <- rowMeans(online_Bellevue_hist_30$MAPE_global[,1:47], na.rm = T)
MAPE_per_week[2, , 5] <- rowMeans(result_Bellevue_NAIVE_Bellevue$MAPE_global[,1:47], na.rm = T) #naive
MAPE_per_week[4, , 5] <- rowMeans(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[,1:47], na.rm = T) #knn_direct
MAPE_per_week[3, , 5] <- rowMeans(result_Bellevue_kNN_DEV_Bellevue$MAPE_global[,1:47], na.rm = T) #knn_dev
day <- 5
for(i in 1:29){
  if ( (day+i)%%7 == 0 ){
    num_day <- 7
  ...
  MAPE_per_week[1, , num_day] <- MAPE_per_week[1, , num_day] + 
                             rowMeans(online_Bellevue_hist_30$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #svr
  MAPE_per_week[2, , num_day] <- MAPE_per_week[2, , num_day] + rowMeans(result_Bellevue_NAIVE_Bellevue$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #naive
  MAPE_per_week[4, , num_day] <- MAPE_per_week[4, , num_day] + rowMeans(result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #knn_direct
  MAPE_per_week[3, , num_day] <- MAPE_per_week[3, , num_day] + rowMeans(result_Bellevue_kNN_DEV_Bellevue$MAPE_global[,(i*48):(i*48+47)], na.rm = T) #knn_dev
}
...
#convert NA to 0
MAPE_global_svr <- online_Bellevue_hist_30$MAPE_global #svr
MAPE_global_svr[is.na(online_Bellevue_hist_30$MAPE_global)] <- 0
NAIVE_GlobalMAPE.0 <- result_Bellevue_NAIVE_Bellevue$MAPE_global #naive
NAIVE_GlobalMAPE.0[is.na(NAIVE_GlobalMAPE.0)] <- 0
kNN_DIRECT_GlobalMAPE.0 <- result_Bellevue_kNN_DIRECT_Bellevue$MAPE_global # knn_direct
kNN_DIRECT_GlobalMAPE.0[is.na(kNN_DIRECT_GlobalMAPE.0)] <- 0
kNN_DEV_GlobalMAPE.0 <- result_Bellevue_kNN_DEV_Bellevue$MAPE_global #knn_dev
...
#convert NA to 0
online_Bellevue_hist_30_relative_ERROR <- online_Bellevue_hist_30$relative_ERROR #svr
online_Bellevue_hist_30_relative_ERROR[is.na(online_Bellevue_hist_30$relative_ERROR)] <- 0
result_Bellevue_NAIVE_Bellevue_relative_ERROR <- result_Bellevue_NAIVE_Bellevue$relative_ERROR #naive
result_Bellevue_NAIVE_Bellevue_relative_ERROR[is.na(result_Bellevue_NAIVE_Bellevue_relative_ERROR)] <- 0
result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR<- result_Bellevue_kNN_DIRECT_Bellevue$relative_ERROR # knn_direct
result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[is.na(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR)] <- 0
result_Bellevue_kNN_DEV_Bellevue_relative_ERROR <- result_Bellevue_kNN_DEV_Bellevue$relative_ERROR #knn_dev
result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[is.na(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR)] <- 0

for(i in 1:1439){
  for(h in 1:6){
    ### erreurs négatives
    #svr
    if( !is.na(mean( online_Bellevue_hist_30_relative_ERROR[ which(online_Bellevue_hist_30_relative_ERROR[,h,i] < 0), h,i], na.rm = T)) ){
    MAPE_per_hours_sign[1, 1, h, hours[i]+1] <- MAPE_per_hours_sign[1, 1, h, hours[i]+1] + mean( online_Bellevue_hist_30_relative_ERROR[ which(online_Bellevue_hist_30_relative_ERROR[,h,i] < 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[1, 1, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[1, 1, h, hours[i]+1] + length(which(online_Bellevue_hist_30_relative_ERROR[,h,i] < 0))
    }
    #naive
    if( !is.na( mean(  result_Bellevue_NAIVE_Bellevue_relative_ERROR[ which(result_Bellevue_NAIVE_Bellevue_relative_ERROR[,h,i] < 0), h,i], na.rm = T))){
      MAPE_per_hours_sign[1, 2, h, hours[i]+1] <- MAPE_per_hours_sign[1, 2, h, hours[i]+1] + mean(  result_Bellevue_NAIVE_Bellevue_relative_ERROR[ which(result_Bellevue_NAIVE_Bellevue_relative_ERROR[,h,i] < 0), h,i], na.rm = T)
      nb_percentage_error_per_hours_sign[1, 2, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[1, 2, h, hours[i]+1] + length(which(result_Bellevue_NAIVE_Bellevue_relative_ERROR[,h,i] < 0))
    }
    #knn_direct
    if( !is.na(mean(  result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[,h,i] < 0), h,i], na.rm = T) ) ){
    MAPE_per_hours_sign[1, 4, h, hours[i]+1] <- MAPE_per_hours_sign[1, 4, h, hours[i]+1] + mean(  result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[,h,i] < 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[1, 4, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[1, 4, h, hours[i]+1] + length(which(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[,h,i] < 0))
    }
    #knn_dev
    if( !is.na(mean(  result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[,h,i] < 0), h,i], na.rm = T) )){
    MAPE_per_hours_sign[1, 3, h, hours[i]+1] <- MAPE_per_hours_sign[1, 3, h, hours[i]+1] + mean(  result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[,h,i] < 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[1, 3, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[1, 3, h, hours[i]+1] + length(which(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[,h,i] < 0))
    }
    ...
    #svr
    if( !is.na( mean( online_Bellevue_hist_30_relative_ERROR[ which(online_Bellevue_hist_30_relative_ERROR[,h,i] > 0), h,i], na.rm = T))){
    MAPE_per_hours_sign[2, 1, h, hours[i]+1] <- MAPE_per_hours_sign[2, 1, h, hours[i]+1] + mean( online_Bellevue_hist_30_relative_ERROR[ which(online_Bellevue_hist_30_relative_ERROR[,h,i] > 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[2, 1, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[2, 1, h, hours[i]+1] + length(which(online_Bellevue_hist_30_relative_ERROR[,h,i] > 0))
    }
    #naive
    if( !is.na(mean(  result_Bellevue_NAIVE_Bellevue_relative_ERROR[ which(result_Bellevue_NAIVE_Bellevue_relative_ERROR[,h,i] > 0), h,i], na.rm = T) )){
    MAPE_per_hours_sign[2, 2, h, hours[i]+1] <- MAPE_per_hours_sign[2, 2, h, hours[i]+1] + mean(  result_Bellevue_NAIVE_Bellevue_relative_ERROR[ which(result_Bellevue_NAIVE_Bellevue_relative_ERROR[,h,i] > 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[2, 2, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[2, 2, h, hours[i]+1] + length(which(result_Bellevue_NAIVE_Bellevue_relative_ERROR[,h,i] > 0))
    }
    #knn_direct
    if( !is.na(mean(  result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[,h,i] > 0), h,i], na.rm = T) )){
    MAPE_per_hours_sign[2, 4, h, hours[i]+1] <- MAPE_per_hours_sign[2, 4, h, hours[i]+1] + mean(  result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[,h,i] > 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[2, 4, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[2, 4, h, hours[i]+1] + length(which(result_Bellevue_kNN_DIRECT_Bellevue_relative_ERROR[,h,i] > 0))
    }
    #knn_dev
    if( !is.na(  mean(  result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[,h,i] > 0), h,i], na.rm = T))){
    MAPE_per_hours_sign[2, 3, h, hours[i]+1] <- MAPE_per_hours_sign[2, 3, h, hours[i]+1]+ mean(  result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[ which(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[,h,i] > 0), h,i], na.rm = T)
    nb_percentage_error_per_hours_sign[2, 3, h, hours[i]+1] <- nb_percentage_error_per_hours_sign[2, 3, h, hours[i]+1] + length(which(result_Bellevue_kNN_DEV_Bellevue_relative_ERROR[,h,i] > 0))
    }
